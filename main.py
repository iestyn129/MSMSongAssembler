	...
	for midi_file in midi_files:
		...
		for key in ['MAJ', 'MIN']:
			...
			for track in song.tracks:
				...
				#	continue
				if song.island_id == 31 and key.upper() not in track.name.upper():
					continue
			...
			song_audio.export(
				output_folder.joinpath(f'{song.name}{f'_{key}' if song.island_id == 31 else ""}.mp3'),
				format='mp3',
				bitrate='192k',
				tags={
					'Name': song.name,
